...
class ControllerProductSearch extends Controller { 	
	public function index() { 
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			//¬ызов метода getFoundProducts должен проводитс€ сразу же после getProducts
			//только тогда он выдает правильное значени€ количества товаров
			...
			foreach ($results as $result) {
                ...
                $set1 = $this->config->get('config_image_product_width') + 200; // Ўирина зум изображени€ основного фото
                $set2 = $this->config->get('config_image_product_height')/$this->config->get('config_image_product_width')*$set1; // ¬ысота зум изображени€ основного фото
				...
				$set3 = $this->config->get('config_image_product_width') + 272; // Ўирина зум изображени€ дополнительных фото
                $set4 = $this->config->get('config_image_product_height')/$this->config->get('config_image_product_width')*$set3; // ¬ысота зум изображени€ дополнительных фото
				...
				foreach ($imgs as $imgi) {
					$imgt[] = array(
						...
						'thumb1' => $this->model_tool_image->resize($imgi['image'], $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height')), // –есайз дополнительного зум изображени€ при клике на иконку дополнительного изображени€
