...
<?php } ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/stretch-shop/stylesheet/stylesheet.css" />
...
<?php } ?>
<!--[if IE 7]> 
<link rel="stylesheet" type="text/css" href="catalog/view/theme/stretch-shop/stylesheet/ie7.css" />
<![endif]-->
<!--[if lt IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/stretch-shop/stylesheet/ie6.css" />
...
<div id="top">
  ...
  <div class="telefon"><?php echo $this->config->get('config_telephone'); ?></div>
  <div class="telefonimg"><img src="catalog/view/theme/stretch-shop/image/telefon-img.png" /></div>
  <div class="cartimg"><img src="catalog/view/theme/stretch-shop/image/cart-img.jpg" /></div>
</div>
<?php if ($categories) { ?>
    <div id="header-menu">
      <div id="menu">
						...
						<li class="dropdown-level"> 
						  ...
						  <?php if($levels_2) {  ?>
							<?php if ($category['children'][$i]['image']) { ?> 
								<img src="<?php echo $category['children'][$i]['image']; ?>" />
							<?php } else { ?>
