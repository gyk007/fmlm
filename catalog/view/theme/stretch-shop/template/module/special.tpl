...
$imagezoom="1"; //Если установлено "1", то будет эффект зума при наведении в модуле Акции
                 //Если установлено "0", то не будет эффекта зума при наведении в модуле Акции

$hoveradditional='1';  //Если указать "1", то будут внизу товара при надении на него отображаться блок с дополнительными изображениями и 		атрибутами в модуле Акции
                    //Если указать "0", то не будут внизу товара при надении на него отображаться блок с дополнительными изображениями и атрибутами в модуле Акции
                 
                
//Перечисленная ниже настройка работает только при включенном значении $hoveradditional
$additionalimage='1';  //Если указать "1", то будут отображаться дополнительные изображения товара в списке товаров в модуле Акции
                    //Если указать "0", то не будут отображаться дополнительные изображения товара в списке товаров в модуле Акции
