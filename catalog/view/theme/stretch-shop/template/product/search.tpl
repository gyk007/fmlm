...
$imagezoom="1"; //≈сли установлено "1", то будет эффект зума при наведении на странице ѕоиска
                 //≈сли установлено "0", то не будет эффекта зума при наведении на странице ѕоиска

$hoveradditional='1';  //≈сли указать "1", то будут внизу товара при надении на него отображатьс€ блок с дополнительными изображени€ми и 		атрибутами на странице ѕоиска
                    //≈сли указать "0", то не будут внизу товара при надении на него отображатьс€ блок с дополнительными изображени€ми и атрибутами на странице ѕоиска
                 
                
//ѕеречисленна€ ниже настройка работает только при включенном значении $hoveradditional
$additionalimage='1';  //≈сли указать "1", то будут отображатьс€ дополнительные изображени€ товара в списке товаров на странице ѕоиска
                    //≈сли указать "0", то не будут отображатьс€ дополнительные изображени€ товара в списке товаров на странице ѕоиска
